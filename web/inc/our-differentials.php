        ...
        <div class="our-differentials__box__scroll-box">
            ...
            <main class="our-differentials__box__scroll-box__main">
                ...
                <article class="our-differentials__box__scroll-box__main__item">
                    <img width="50" height="50" src="<?= url("web/assets/img/icon/price.svg"); ?>" title="Temos o melhor preço do mercado" alt="Temos o melhor preço do mercado">
                ...
                <article class="our-differentials__box__scroll-box__main__item">
                    <img width="50" height="50" src="<?= url("web/assets/img/icon/safety.svg"); ?>" title="Segurança" alt="Segurança">
                    <h1>Segurança!</h1>
                </article>

                <article class="our-differentials__box__scroll-box__main__item">
                    <img width="50" height="50" src="<?= url("web/assets/img/icon/style.svg"); ?>" title="Estilo" alt="Estilo">
                    <h1>Estilo!</h1>
                </article>

                <article class="our-differentials__box__scroll-box__main__item">
                    <img width="50" height="50" src="<?= url("web/assets/img/icon/structure.svg"); ?>" title="Durabilidade" alt="Durabilidade">
                    <h1>Durabilidade!</h1>
                </article>
            </main>
